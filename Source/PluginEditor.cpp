                                   ...
                                   juce::Slider &slider)
{
    ...
    g.setColour(enabled ? Colour(25u, 25u, 25u) : Colours::darkgrey);
    g.fillEllipse(bounds);
    g.setColour(enabled ? Colour(100u, 100u, 100u) : Colours::grey);
...
void LookAndFeel::drawToggleButton(juce::Graphics &g, juce::ToggleButton &toggleButton, bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown)
{
    ...
    auto color = toggleButton.getToggleState() ? Colours::dimgrey : Colour(201u, 0u, 0u);
...
void PathProducer::process(juce::Rectangle<float> fftBounds, double sampleRate)
{
    ...
    while(leftChannelFFTDataGenerator.getNumAvailableFFTDataBlocks() > 0)
    {
        ...
        {
            pathProducer.generatorPath(fftData, fftBounds, fftSize, binWidth, -48.f);
        }
    }
...
peakBypassButtonAttachment(audioProcessor.apvts, "Peak Bypassed", lowcutBypassButton),
